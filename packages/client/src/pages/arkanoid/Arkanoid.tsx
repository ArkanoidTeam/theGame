  ...
  return (
    <Page>
      ...
      <Modal
        ...
        <ul>
          <li>Нажмите пробел для старта</li>
          <li>Стрелками перемещайте платформу для ловли шарика</li>
          <li>
            Разбивайте кирпичики с иконками бонусов, чтобы получить улучшения
          </li>
          <li>Игра заканчивается, если шарик падает мимо платформы 3 раза</li>
        </ul>
      </Modal>
      <GameDialog
